...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: 'prueba', data: { breadcrumb: 'Prueba' }, loadChildren: () => import('./demo/components/uikit/uikit.module').then(m => m.UIkitModule) },
            ...
            { path: 'usuarios', data: { breadcrumb: 'Usuarios' }, loadChildren: () => import('./pages/usuarios/usuario.module').then(m => m.UsuarioModule) }
        ]
    },
